...
sidebar_menu = sidebarMenu(
   ...
   menuItem( "理論的背景",    tabName = "backgroaund", icon = icon("history"),     badgeLabel = "not yet", badgeColor = "purple"),
...
server <- function(input, output, session){
   ...
   # Tab: IC50_90_99
   server_IC50_90_99(input, output, session)
